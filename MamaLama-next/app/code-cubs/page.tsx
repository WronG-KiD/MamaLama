...
export default function CodeCubsPage() {
  return (
    <div className="view active">
      <section className="page-section">
        ...
        <div className="coming-soon-hero">
          ...
          <h1>Code Cubs <span className="accent-text">🧑‍💻</span></h1>
          <p className="coming-soon-tag">
            Where tiny coders learn to think like engineers.
          </p>
          <p className="coming-soon-desc">
            ...
            Each Code Cubs kit pairs a physical box with a story arc and a digital companion that grows with your child.
          </p>
          <ul className="coming-soon-list">
            ...
            <li>🏆 Earn special <strong>Code Cubs tier badges</strong> on your Sky Trail.</li>
          </ul>
